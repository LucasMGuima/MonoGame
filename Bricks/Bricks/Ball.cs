...
namespace Bricks
{
    internal class Ball
    {
        ...
        public float ScreenWidth { get; set; } //Largura da tela de jogo
        public float ScreenHeight { get; set; } //Altura da tela de jogo
        public bool Visible { get; set; } //A bola está visivisel na tela
        public int Score { get; set; }
        public int bricksCleared { get; set; } //Numero de blocos limpos nesse nivel
        ...
        public bool Move(Wall wall, Paddle paddle)
        {
            ...
            //Checa por colisaão com a parede
            if(X < 1)
            {
                X = 1;
            ...
            //checa por colisão com o paddle
            //paddle tem 70 pixels. Vamos dividir ele em segmentos que indicaram a direção da bola
